...
CHROMA_VACANCIES_COLLECTION = os.getenv('CHROMA_VACANCIES_COLLECTION', 'bot_vacancies')
CHROMA_QUERIES_COLLECTION = os.getenv('CHROMA_QUERIES_COLLECTION', 'bot_queries')
